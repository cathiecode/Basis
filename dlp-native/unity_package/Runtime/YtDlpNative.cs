...
namespace YtDlp.Native
{
    ...
    internal static class NativeLib
    {
        ...
        internal delegate void LogCallback(int level, IntPtr message, int length);

        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void unity_dlp_set_log_callback(LogCallback callback);

        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void unity_dlp_clear_log_callback();
